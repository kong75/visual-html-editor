...
import { fontFamilyOptionsFor } from './font-options.js';
      ...
      {profile.capabilities.editStyles && typographyProperties.some(allowsStyle) && (
        <section className="vhe-inspector-section">
          ...
          <div className="vhe-property-grid">
            {allowsStyle('font-family') && <InspectorSelect label="Font" property="font-family" value={propertyDrafts['font-family'] ?? ''} options={fontFamilyOptionsFor(propertyDrafts['font-family'])} onChange={updateStyleDraft} onCommit={applyStyle} />}
