...
import { Bold, Italic, SlidersHorizontal, Strikethrough, Underline } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="vhe-inline-format__bar" role="toolbar" aria-label="Selected text controls">
        ...
        <StyleField compact disabled={!canApply('font-family')} label="Font" property="font-family" value={selection.activeStyles['font-family']} placeholder="Font" onApply={apply} />
