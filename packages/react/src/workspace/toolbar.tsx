...
interface EditorToolbarProps extends Pick<VisualHtmlEditorProps, 'brandHref' | 'toolbarContent' | 'importAdapter'> {
  ...
  htmlImportButtonRef: React.RefObject<HTMLButtonElement | null>;
  htmlInputRef: React.RefObject<HTMLInputElement | null>;
...
export function EditorToolbar({ brandHref, documentTitle, toolbarContent, profile, aspect, setAspectId, htmlImportButtonRef, htmlInputRef, imageInputRef, exportHtml, importAdapter, prepareHtmlImport, handleImage }: EditorToolbarProps) {
  return (
