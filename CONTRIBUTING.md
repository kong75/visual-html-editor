...
Use Node.js 24.11.1 (pinned in `.nvmrc`) and pnpm 10.22.0. The development toolchain also supports the Node 22 line starting at 22.18.0. Package runtime requirements are different; see [compatibility](./docs/compatibility.md).
